...
export const Home = () => {
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-20">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-200/40 dark:bg-brand-purple/20 rounded-full blur-[120px]" 
          />
          <motion.div 
            animate={{ 
              x: [0, 50, 0],
            ...
            className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-purple-200/30 dark:bg-brand-pink/20 rounded-full blur-[100px]" 
          />
          <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-cyan-200/20 dark:bg-brand-yellow/20 rounded-full blur-[100px]" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <RevealOnScroll>
            <div className="inline-flex items-center px-4 py-2 rounded-full border border-brand-orange/20 bg-white dark:bg-slate-800 text-brand-orange text-sm font-medium mb-8 shadow-sm">
          ...
          <RevealOnScroll delay={600}>
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
              <Link to="/contact" className="px-8 py-4 rounded-lg bg-brand-orange hover:bg-orange-600 text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-blue-500/30">
                Book Consultation
              </Link>
              {/* Glass panel for light mode */}
              <Link to="/services" className="px-8 py-4 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:text-brand-orange font-semibold transition-all duration-300 flex items-center group hover:border-brand-orange/50 shadow-sm hover:shadow-md">
                View Solutions
          ...
          <RevealOnScroll delay={800}>
             <div className="relative mx-auto max-w-5xl rounded-xl border border-slate-200 dark:border-slate-700 bg-white/50 dark:bg-slate-900/50 p-2 md:p-4 backdrop-blur-xl shadow-2xl">
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-3/4 h-20 bg-blue-100/50 dark:bg-blue-500/20 blur-[60px] -z-10"></div>
                <DashboardMockup />
                {/* Decoration overlay */}
                <div className="absolute -right-12 -bottom-12 w-24 h-24 bg-cyan-100/50 dark:bg-cyan-500/20 blur-2xl rounded-full"></div>
             </div>
          </RevealOnScroll>
        </div>
      </section>
      ...
      <section className="py-12 border-y border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <RevealOnScroll key={idx} delay={idx * 100}>
                ...
                <div className="text-sm text-brand-orange uppercase tracking-wider font-semibold">{stat.label}</div>
              </RevealOnScroll>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-16">
                <div className="lg:w-1/2">
                    <RevealOnScroll>
                        <div className="inline-flex items-center px-3 py-1 rounded-full border border-purple-200 dark:border-purple-800 bg-purple-50 dark:bg-purple-900/30 text-brand-pink text-xs font-bold mb-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                            {[
                                ...
                                <div key={i} className="flex items-start">
                                    <div className="mt-1 w-2 h-2 rounded-full bg-brand-orange shadow-sm mr-3"></div>
                                    <div>
                                        <h4 className="text-white font-bold text-sm">{f.t}</h4>
                                        <p className="text-slate-500 dark:text-slate-500 text-xs">{f.d}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <Link to="/services" className="text-brand-orange border-b border-brand-orange pb-1 hover:text-orange-600 transition-colors">
                            View Sample Reports
                        </Link>
                    </RevealOnScroll>
                </div>
